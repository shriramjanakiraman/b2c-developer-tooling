...
import EcdnMtlsDelete from '../../../../src/commands/ecdn/mtls/delete.js';
import {createIsolatedConfigHooks, createTestCommand} from '../../../helpers/test-setup.js';

describe('ecdn mtls delete', () => {
  ...
  async function createCommand(flags: Record<string, unknown> = {}) {
    return createTestCommand(EcdnMtlsDelete, hooks.getConfig(), flags, {});
  }
  ...
  it('deletes mTLS certificate in JSON mode', async () => {
  ...
  it('deletes certificate in non-JSON mode', async () => {
    const command: any = await createCommand({
      'tenant-id': 'zzxy_prd',
