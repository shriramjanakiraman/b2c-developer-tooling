...
import EcdnCipherSuitesGet from '../../../../src/commands/ecdn/cipher-suites/get.js';
import {createIsolatedConfigHooks, createTestCommand} from '../../../helpers/test-setup.js';

describe('ecdn cipher-suites get', () => {
  ...
  async function createCommand(flags: Record<string, unknown> = {}) {
    return createTestCommand(EcdnCipherSuitesGet, hooks.getConfig(), flags, {});
  }
  ...
  it('returns cipher suites in JSON mode', async () => {
  ...
  it('displays cipher suites in non-JSON mode', async () => {
    const command: any = await createCommand({'tenant-id': 'zzxy_prd', zone: 'my-zone'});
